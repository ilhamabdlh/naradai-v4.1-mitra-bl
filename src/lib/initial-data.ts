...
function buildMitraBukalapakDashboardInitial(base: DashboardContentStore): DashboardContentStore {
  ...
  return {
    ...
    competitiveMatrixItems: [
      { id: "1", name: "Mitra Shopee", mentions: 304, positivePercentage: 60.8, size: 304, color: "bg-orange-500" },
      { id: "2", name: "Mitra Bukalapak", mentions: 90, positivePercentage: 64.8, size: 90, color: "bg-red-600" },
      { id: "3", name: "Order Kuota", mentions: 63, positivePercentage: 42.2, size: 63, color: "bg-blue-500" },
    ],
    competitiveQuadrantAnalysis: [

...
function buildBeningsInitial(d: DashboardContentStore): DashboardContentStore {
  return {
    ...
    campaignPerformance: [
      { id: "1", name: "Brand Core - Bening's IG",    platform: "Instagram",   likes: 1820, shares: 85, replies: 150, sentiment: 0.925, status: "active"    },
      { id: "2", name: "Brand Core - Bening's TikTok",platform: "TikTok",      likes: 630,  shares: 27, replies: 285, sentiment: 0.785, status: "active"    },
      { id: "3", name: "Bening's Brand & Issue",       platform: "Twitter",     likes: 215,  shares: 35, replies: 85,  sentiment: 0.655, status: "active"    },
      { id: "4", name: "Outlet Review & Sentiment",    platform: "Google Maps", likes: 45,   shares: 0,  replies: 142, sentiment: 0.890, status: "ongoing"   },
    ],
    campaignTrendData: [
    ...
    campaignCompetitors: [
      { id: "1", brand: "Bening's",      posts: 417, likes: 2710, replies: 662, shares: 147, sentiment: 0.842 },
      { id: "2", brand: "ZAP Clinic",    posts: 280, likes: 1850, replies: 410, shares: 95,  sentiment: 0.815 },
      { id: "3", brand: "Erha",          posts: 210, likes: 1520, replies: 320, shares: 65,  sentiment: 0.750 },
      { id: "4", brand: "Sozo",          posts: 185, likes: 1120, replies: 210, shares: 45,  sentiment: 0.820 },
      { id: "5", brand: "Derma Express", posts: 150, likes: 980,  replies: 185, shares: 50,  sentiment: 0.850 },
      { id: "6", brand: "Natasha",       posts: 95,  likes: 450,  replies: 90,  shares: 15,  sentiment: 0.680 },
      { id: "7", brand: "Dermaster",     posts: 65,  likes: 320,  replies: 85,  shares: 10,  sentiment: 0.880 },
      { id: "8", brand: "Airin",         posts: 55,  likes: 280,  replies: 65,  shares: 12,  sentiment: 0.760 },
      { id: "9", brand: "Naavagreen",    posts: 45,  likes: 190,  replies: 55,  shares: 8,   sentiment: 0.650 },
    ],
    ...
    outletSentimentByOutlet: [
      ...
      { id: "10", name: "Jember",      positive: 0,  neutral: 0,  negative: 0,  noNewReviews: true },
      { id: "11", name: "Cirebon",     positive: 0,  neutral: 0,  negative: 0,  noNewReviews: true },
      { id: "12", name: "Metro",       positive: 0,  neutral: 0,  negative: 0,  noNewReviews: true },

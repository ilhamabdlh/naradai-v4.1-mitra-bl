...
import { buildMitraBukalapakCampaigns } from "./mitra-bukalapak-campaigns";
...
function buildBukalapakInitial(base: DashboardContentStore): DashboardContentStore {
  return {
    ...
    opportunities: [
      {
        ...
        trend: "Trending",
        supportingContents: 1,
        metrics: { sentimentScore: 84.4, marketPotential: 1, reachGrowth: 1 },
      ...
      },
      {
        ...
        trend: "Stable",
        supportingContents: 1,
        metrics: { sentimentScore: 84.0, marketPotential: 0.7, reachGrowth: 0.8 },
    ...
    whatsHappeningSentimentTrends: [
      { date: "Dec 20", positive: 5, negative: 2, neutral: 0 },
      { date: "Dec 21", positive: 0, negative: 0, neutral: 1 },
      { date: "Dec 22", positive: 0, negative: 0, neutral: 0 },
      { date: "Dec 23", positive: 0, negative: 0, neutral: 0 },
      { date: "Dec 24", positive: 0, negative: 0, neutral: 0 },
      { date: "Dec 25", positive: 3, negative: 3, neutral: 0 },
      { date: "Dec 26", positive: 4, negative: 0, neutral: 0 },
      { date: "Dec 27", positive: 0, negative: 2, neutral: 0 },
      { date: "Dec 28", positive: 2, negative: 0, neutral: 0 },
      { date: "Dec 29", positive: 1, negative: 1, neutral: 0 },
      { date: "Dec 30", positive: 0, negative: 0, neutral: 0 },
      { date: "Dec 31", positive: 2, negative: 0, neutral: 0 },
      { date: "Jan 01", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 02", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 03", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 04", positive: 0, negative: 2, neutral: 0 },
      { date: "Jan 05", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 06", positive: 2, negative: 0, neutral: 0 },
      { date: "Jan 07", positive: 0, negative: 3, neutral: 0 },
      { date: "Jan 08", positive: 3, negative: 1, neutral: 0 },
      { date: "Jan 09", positive: 1, negative: 0, neutral: 0 },
      { date: "Jan 10", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 11", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 12", positive: 0, negative: 1, neutral: 0 },
      { date: "Jan 13", positive: 3, negative: 2, neutral: 0 },
      { date: "Jan 14", positive: 2, negative: 2, neutral: 0 },
      { date: "Jan 15", positive: 5, negative: 4, neutral: 0 },
      { date: "Jan 16", positive: 1, negative: 0, neutral: 0 },
      { date: "Jan 17", positive: 2, negative: 0, neutral: 0 },
      { date: "Jan 18", positive: 0, negative: 0, neutral: 0 },
      { date: "Jan 19", positive: 0, negative: 1, neutral: 1 },
    ],
...
function buildBeningsInitial(d: DashboardContentStore): DashboardContentStore {
  return {
    ...
    whatsHappeningShareOfPlatform: [
      { date: "Feb 25", twitter: 0, instagram: 0, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Feb 26", twitter: 0, instagram: 2, facebook: 0, tiktok: 2, googlemaps: 0 },
      { date: "Feb 27", twitter: 0, instagram: 1, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Feb 28", twitter: 0, instagram: 0, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Mar 01", twitter: 0, instagram: 2, facebook: 0, tiktok: 0, googlemaps: 0 },
      { date: "Mar 02", twitter: 0, instagram: 0, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Mar 03", twitter: 0, instagram: 0, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Mar 04", twitter: 0, instagram: 1, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Mar 05", twitter: 0, instagram: 2, facebook: 0, tiktok: 1, googlemaps: 0 },
      { date: "Mar 06", twitter: 1, instagram: 3, facebook: 0, tiktok: 4, googlemaps: 1 },
      { date: "Mar 07", twitter: 1, instagram: 5, facebook: 0, tiktok: 8, googlemaps: 2 },
      { date: "Mar 08", twitter: 0, instagram: 8, facebook: 0, tiktok: 10, googlemaps: 3 },
      { date: "Mar 09", twitter: 2, instagram: 12, facebook: 0, tiktok: 15, googlemaps: 1 },
    ],
    competitiveMatrixItems: [
      {
        id: "1",
...
function buildBeningsCampaignInitial(d: DashboardContentStore): DashboardContentStore {
  return {
    ...d,
    // ── Campaign Analysis: override only campaign-* fields for this instance ──
    campaignStats: [
      {
        id: "1",
        label: "Average Sentiment",
        ...
        change: "+2.2pts",
        positive: true,
        description: "Positive sentiment ratio based on 328 validated mentions (Cleaned)",
        icon: "TrendingUp",
      },
      {
        id: "2",
      ...
      },
      {
        ...
        change: "+3.2pts",
        positive: true,
        description: "Bening's SOV vs 8 Major Competitors",
        icon: "MessageSquare",
      },
      {
        id: "4",
        ...
        change: "+107",
        positive: true,
        description: "Total validated Bening's mentions in current dataset",
        icon: "Users",
      },
    ],
    campaignPerformance: [
      {
        id: "1",
        name: "Berkah Promo Ramadan (Tier-2 Rollout)",
        platform: "TikTok",
        likes: 845,
        shares: 42,
        replies: 350,
      ...
      {
        id: "2",
        name: "Moisture Gel Education Series",
        platform: "Instagram",
        likes: 2450,
        shares: 115,
        replies: 210,
      ...
      {
        id: "3",
        name: "Service Experience Thread (Queue + SOP)",
        platform: "Twitter",
        likes: 265,
        shares: 40,
        replies: 105,
      ...
      {
        id: "4",
        name: "Google Maps Review Push (Bogor Benchmark)",
        platform: "Google Maps",
        likes: 65,
        shares: 0,
        replies: 168,
    ...
    campaignTrendData: [
      ...
      { id: "2", month: "Mar 2026", likes: 3625, shares: 197, replies: 833 },
      { id: "3", month: "Apr 2026", likes: 1450, shares: 85, replies: 420 },
    ],
    campaignTimeSeriesData: [
      { id: "1", date: "25 Feb", likes: 120, replies: 25, shares: 5 },
      { id: "2", date: "26 Feb", likes: 150, replies: 30, shares: 8 },
      { id: "3", date: "27 Feb", likes: 165, replies: 35, shares: 10 },
      { id: "4", date: "28 Feb", likes: 210, replies: 45, shares: 12 },
      { id: "5", date: "01 Mar", likes: 550, replies: 120, shares: 45 },
      { id: "6", date: "02 Mar", likes: 350, replies: 112, shares: 32 },
      { id: "7", date: "03 Mar", likes: 280, replies: 78, shares: 21 },
      { id: "8", date: "04 Mar", likes: 310, replies: 85, shares: 24 },
      { id: "9", date: "05 Mar", likes: 420, replies: 110, shares: 38 },
      { id: "10", date: "06 Mar", likes: 380, replies: 95, shares: 29 },
      { id: "11", date: "07 Mar", likes: 460, replies: 125, shares: 45 },
      { id: "12", date: "08 Mar", likes: 580, replies: 145, shares: 62 },
      { id: "13", date: "09 Mar", likes: 750, replies: 185, shares: 85 },
    ],
    campaignPostPublishEvents: [
      { id: "1", date: "26 Feb", label: "Moisture Gel Carousel Published", type: "carousel" },
      { id: "2", date: "01 Mar", label: "TikTok Promo Video Posted", type: "short_video" },
      { id: "3", date: "02 Mar", label: "Service SOP Thread Posted", type: "thread" },
      { id: "4", date: "05 Mar", label: "Deep Moisture Gel 'Skin Barrier' Campaign", type: "carousel" },
    ],
    campaignKeyEvents: [
      {
        id: "1",
        date: "01 Mar",
        title: "Engagement Spike on Education Content",
        type: "spike",
        insight:
          "Educational content around skin barrier repair significantly increased save/share rates and improved positive sentiment for product-related conversations.",
      },
      {
        id: "2",
        date: "02 Mar",
        title: "Sentiment Drop from Queue Complaints",
        type: "drop",
        insight:
          "Operational complaints regarding waiting times in regional outlets surfaced in replies, slightly reducing the overall campaign sentiment on service-related posts.",
      },
      {
        id: "3",
        date: "05 Mar",
        title: "Viral Momentum for Skinmology",
        type: "spike",
        insight:
          "A massive surge in positive organic mentions praising Deep Moisture Gel's effectiveness for skin hydration entering the fasting month.",
      },
      {
        id: "4",
        date: "09 Mar",
        title: "Admin Bottleneck Impact",
        type: "drop",
        insight:
          "A high volume of Ramadan promo inquiries led to SLA failures, triggering a noticeable spike in 'Slow Response' complaints across Instagram and TikTok DMs.",
      },
    ],
    campaignReplySentiment: { positive: 68, neutral: 17, negative: 15 },
    campaignReplyTopics: [
      {
        id: "1",
        topic: "Promo & Pricing",
        ...
        negative: 20,
        topComments: [
          "Promonya jelas banget, jadi enak nentuin treatment",
          "Diskonnya lumayan tapi minta info paket lengkap dong",
          "Kalau tier-2 ada promo harian kayak Kendari, pasti rame",
        ],
      },
      {
        id: "2",
        topic: "Admin / Booking Response",
        totalReplies: 185,
        positive: 25,
        neutral: 20,
        negative: 140,
        topComments: [
          "DM udah lama belum dibales admin",
          "aku reservasi ngga dijawab ma admin padahal mau jadwalin buat besok",
          "Tolong respon lebih cepat, mau konsultasi promo Ramadhan",
        ],
      },
      {
        id: "3",
        topic: "Product (Moisture Gel)",
        totalReplies: 145,
        positive: 125,
        neutral: 15,
        negative: 5,
        topComments: [
          "Selain melembapkan, Deep Moisture Gel juga bantu perbaiki skin barrier",
          "Cocok banget dipakai pas puasa biar gak dehidrasi",
          "Produknya cepet banget sold out di cabangku",
        ],
      },
    ],
    campaignContentTypes: [
      {
        ...
        negativeSentiment: 4,
        topTopics: ["skin barrier", "hydration", "product education"],
        audienceReaction:
          "High trust-building impact; shares driven by practical tips and Ramadan preparation.",
      },
      {
        id: "2",
        type: "Short Promo Video",
        platform: "TikTok",
        posts: 12,
        likes: 980,
        shares: 52,
        ...
        topTopics: ["promo", "booking", "tier-2 cities"],
        audienceReaction:
          "High reach; negative replies heavily skewed towards slow admin response speeds.",
      },
      {
        id: "3",
        type: "Google Maps Review CTA",
        ...
        topTopics: ["service", "facility", "staff hospitality"],
        audienceReaction:
          "Good for credibility; highlights branch-level inconsistency and queue times.",
      },
    ],
    campaignTopPosts: [
      {
        id: "1",
        type: "carousel",
        title: "Skin Barrier 101 + Deep Moisture Gel",
        platform: "Instagram",
        likes: 620,
        shares: 45,
        replies: 32,
      ...
      },
      {
        id: "2",
        type: "short_video",
        title: "Berkah Promo: Tier-2 Branch Deals",
        platform: "TikTok",
        likes: 485,
        shares: 28,
        replies: 165,
      ...
      },
      {
        id: "3",
        type: "thread",
        title: "Kenapa antre bisa lama? (SOP & alokasi dokter)",
        platform: "Twitter",
        likes: 115,
        shares: 25,
        replies: 58,
    ...
    campaignCompetitors: [
      { id: "1", brand: "Bening's", posts: 328, likes: 3625, replies: 833, shares: 197, sentiment: 0.735 },
      { id: "2", brand: "ZAP", posts: 110, likes: 2100, replies: 485, shares: 115, sentiment: 0.682 },
      { id: "3", brand: "Erha", posts: 75, likes: 1650, replies: 345, shares: 72, sentiment: 0.54 },
      { id: "4", brand: "Sozo", posts: 82, likes: 1340, replies: 285, shares: 65, sentiment: 0.485 },
      { id: "5", brand: "Natasha", posts: 80, likes: 620, replies: 120, shares: 25, sentiment: 0.551 },
      { id: "6", brand: "Derma Express", posts: 105, likes: 1450, replies: 310, shares: 85, sentiment: 0.61 },
      { id: "7", brand: "Dermaster", posts: 35, likes: 420, replies: 95, shares: 15, sentiment: 0.78 },
      { id: "8", brand: "Airin", posts: 74, likes: 395, replies: 105, shares: 18, sentiment: 0.532 },
      { id: "9", brand: "Naavagreen", posts: 163, likes: 950, replies: 210, shares: 45, sentiment: 0.498 },
    ],
    campaignRecommendations: [
      {
        id: "1",
        priority: "high",
        title: "Improve Admin Response Time for Online Reservations",
        detail:
          "There is a daily increase in complaints regarding slow admin response times when customers attempt to make reservations or inquire about Ramadan promos. Implement a maximum 10-minute reply SLA for WhatsApp and Instagram DMs. Immediately deploy an FAQ chatbot to filter out and handle basic promo inquiries.",
        impact: "High",
      },
      {
        id: "2",
        priority: "high",
        title: "Address Service Delays at Regional Outlets",
        detail:
          "Analysis of reviews for regional branches indicates persistent complaints regarding long waiting times despite having multiple doctors on duty. Deploy an automated queue management system integrated with the booking app to manage patient flow, and conduct a strict audit on standard consultation durations.",
        impact: "High",
      },
      {
        id: "3",
        priority: "high",
        title: "Expand Promotion for Deep Moisture Gel & Skinmology",
        detail:
          "Organic sentiment is exceptionally strong regarding 'Skin barrier' protection using Deep Moisture Gel, especially leading up to the fasting month which often causes dry skin. Double the Ads Spend specifically for the Skinmology series, focusing on the narrative 'Extra Dry Skin Protection During Fasting'.",
        impact: "High",
      },
    ],
  };
...
function buildMitraBukalapakDashboardInitial(base: DashboardContentStore): DashboardContentStore {
  const campaigns = buildMitraBukalapakCampaigns();
  const firstCampaignData = campaigns[0]?.data ?? {};
  return {
    ...base,
    ...firstCampaignData,
    featureVisibility: {
    ...
    statsOverview: [
      { id: "1", label: "Average Sentiment", value: "71.3%", description: "Positive sentiment ratio based on 252 validated mentions", icon: "TrendingUp" },
      { id: "2", label: "Critical Issues", value: "25", description: "Mentions flagged as 'High Risk' (Negative Sentiment)", icon: "AlertTriangle" },
      { id: "3", label: "Share of Voice", value: "29.1%", description: "Bening's SOV vs analyzed market", icon: "MessageSquare" },
      { id: "4", label: "Conversation Analyzed", value: "866", description: "Total validated mentions across all brands", icon: "Activity" },
    ],
    priorityActions: [
      {
        id: "PA001",
        priority: "critical",
        title: "Resolve Application Login and Accessibility Downtime",
        description: "Users are reporting complete inability to access or log into the Mitra Bukalapak application, leading to halted transactions and loss of revenue.",
        impact: "High",
        effort: "High",
        recommendation: "Immediately investigate server load or routing issues causing login failures. Deploy a hotfix and communicate the resolution timeline to users.",
        category: "Product",
        quadrantColor: "red",
        relatedIssues: ["Bug", "Server Downtime", "User Access"],
        metrics: { mentions: 15, sentiment: "16.2%", trend: "Increasing" },
        sourceContent: "kenapa aplikasi mitrabukalapak GK bisa diakses? login pun GK bisa",
      },
      {
        id: "PA002",
        priority: "high",
        title: "Streamline Account Recovery and Phone Number Updates",
        description: "Users are experiencing prolonged difficulties when attempting to update their registered phone numbers, blocking them from accessing their accounts.",
        impact: "High",
        effort: "Medium",
        recommendation: "Optimize the account recovery flow in the Customer Service pipeline. Introduce an automated but secure self-serve portal for updating user credentials.",
        category: "Customer Service",
        quadrantColor: "orange",
        relatedIssues: ["UX/UI", "Account Management"],
        metrics: { mentions: 12, sentiment: "32.5%", trend: "Stable" },
        sourceContent: "Benerin akun bukalapak nya pak dari kemarin gak ada pencerahan nih mau ganti nomer lama ke nomer baru",
      },
      {
        id: "PA003",
        priority: "high",
        title: "Address QRIS Payment Failures Due to Poor Signal",
        description: "Merchants face friction when accepting QRIS payments because customers frequently experience poor cellular signal at the store location.",
        impact: "High",
        effort: "Medium",
        recommendation: "Promote the 'Soundbox' device as a solution to bypass customer phone dependency. Optimize the QRIS generation within the app to require minimal bandwidth.",
        category: "Product",
        quadrantColor: "orange",
        relatedIssues: ["Infrastructure", "Payments"],
        metrics: { mentions: 25, sentiment: "41.8%", trend: "Increasing" },
        sourceContent: "Kebiasaan nih Juragan kalo pelanggan bayar pake QRIS, pasti ada aja susah sinyal😭",
      },
    ],
    risks: [
      {
        id: "R001",
        title: "High Competitor Dominance (Shopee)",
        description: "Shopee exhibits a massive share of voice with 304 mentions, indicating a strong competitive threat in the micro-merchant and digital product space.",
        severity: "High",
        probability: 90,
        impact: "Market Share Loss",
        trend: "Increasing",
        supportingContents: 304,
        sourceContent: [{ id: "r1", platform: "twitter", author: "MarketData", content: "Shopee Dominance: 304 mentions.", sentiment: 0, timestamp: "—", engagement: { likes: 0, replies: 0, retweets: 0 } }],
        indicators: [{ label: "Competitor SOV", value: 1, change: 15 }],
        mitigation: [
          "Aggressively market unique Mitra Bukalapak differentiators",
          "Increase hyper-local promotions to build merchant loyalty.",
        ],
      },
      {
        id: "R002",
        title: "Phishing and Scam Campaigns Targeting Mitras",
        description: "Fraudsters are targeting Mitras with fake 'commission missions' operating under the brand, risking user trust.",
        severity: "Critical",
        probability: 80,
        impact: "Brand Reputation Loss",
        trend: "Increasing",
        supportingContents: 45,
        sourceContent: [{ id: "r2", platform: "twitter", author: "MitraBukalapak", content: "Juragan pernah diiming iming mengerjakan misi dapat komisi? Jelas itu penipuan ya Juragan!", sentiment: 0, timestamp: "—", engagement: { likes: 0, replies: 0, retweets: 0 } }],
        indicators: [{ label: "Fraud Reports", value: 1, change: 1 }],
        mitigation: [
          "Deploy in-app banner warnings about scams",
          "Push educational content on official channels.",
        ],
      },
    ],
    opportunities: [
      {
        id: "O001",
        title: "Accelerate 'Soundbox' Adoption",
        description: "The 'Flash Deal Soundbox' promo generated strong positive engagement and solves QRIS signal issues.",
        potential: "High",
        confidence: 95,
        timeframe: "Short Term",
        category: "Sales & Hardware",
        trend: "Trending",
        supportingContents: 85,
        sourceContent: [{ id: "o1", platform: "twitter", author: "MitraBukalapak", content: "Soundbox QRIS bisa Juragan dapetin cuma Rp1.447 aja! 😱", sentiment: 0.92, timestamp: "—", engagement: { likes: 0, replies: 0, retweets: 0 } }],
        metrics: { sentimentScore: 92, marketPotential: 1, reachGrowth: 1 },
        recommendations: [
          "Increase daily inventory for Soundbox flash sales",
          "Bundle Soundbox with top-up quota purchases.",
        ],
      },
      {
        id: "O002",
        title: "Capitalize on Ramadan Community Engagement",
        description: "The 'NgaBreng' online events combining tips with religious guidance are highly resonant.",
        potential: "High",
        confidence: 90,
        timeframe: "Short Term",
        category: "Community Engagement",
        trend: "Trending",
        supportingContents: 120,
        sourceContent: [{ id: "o2", platform: "twitter", author: "MitraBukalapak", content: "Yuk ikutan NgaBreng 2 (Ngabuburit Bareng Juwara) bersama Mitra Bukalapak!", sentiment: 0.98, timestamp: "—", engagement: { likes: 0, replies: 0, retweets: 0 } }],
        metrics: { sentimentScore: 98, marketPotential: 0.5, reachGrowth: 1 },
        recommendations: [
          "Expand server capacity for Live sessions",
          "Repurpose as short-form content for TikTok/Reels.",
        ],
      },
    ],
    competitiveIssues: [
      { id: "1", issue: "App Error/Bug", category: "Product", yourSentiment: 16.2 / 100, competitorMedianSentiment: 36.6 / 100, yourMentions: 4, competitorMedianMentions: 2.0, relativeSentiment: -55.7, relativeMentions: 100 },
      { id: "2", issue: "General Service", category: "Service", yourSentiment: 85 / 100, competitorMedianSentiment: 78.8 / 100, yourMentions: 82, competitorMedianMentions: 57.0, relativeSentiment: 7.9, relativeMentions: 43.9 },
      { id: "3", issue: "Promo/Pricing", category: "Pricing", yourSentiment: 93.8 / 100, competitorMedianSentiment: 78.3 / 100, yourMentions: 4, competitorMedianMentions: 3.0, relativeSentiment: 19.8, relativeMentions: 33.3 },
    ],
    competitiveKeyInsights: base.competitiveKeyInsights,
    whatsHappeningSentimentTrends: [
      { date: "Feb 09", positive: 1, negative: 0, neutral: 0 },
      { date: "Feb 10", positive: 0, negative: 1, neutral: 0 },
      { date: "Feb 11", positive: 2, negative: 0, neutral: 0 },
      { date: "Feb 12", positive: 0, negative: 2, neutral: 0 },
      { date: "Feb 13", positive: 1, negative: 1, neutral: 0 },
      { date: "Feb 15", positive: 0, negative: 1, neutral: 0 },
      { date: "Feb 16", positive: 1, negative: 0, neutral: 0 },
      { date: "Feb 17", positive: 1, negative: 0, neutral: 0 },
      { date: "Feb 18", positive: 1, negative: 0, neutral: 0 },
      { date: "Feb 19", positive: 3, negative: 1, neutral: 0 },
      { date: "Feb 20", positive: 6, negative: 0, neutral: 0 },
      { date: "Feb 21", positive: 5, negative: 0, neutral: 0 },
      { date: "Feb 22", positive: 3, negative: 0, neutral: 0 },
      { date: "Feb 23", positive: 3, negative: 0, neutral: 0 },
      { date: "Feb 24", positive: 3, negative: 0, neutral: 0 },
      { date: "Feb 25", positive: 9, negative: 1, neutral: 1 },
      { date: "Feb 26", positive: 3, negative: 0, neutral: 1 },
      { date: "Feb 27", positive: 3, negative: 0, neutral: 1 },
      { date: "Feb 28", positive: 1, negative: 0, neutral: 1 },
      { date: "Mar 01", positive: 4, negative: 0, neutral: 0 },
      { date: "Mar 02", positive: 5, negative: 0, neutral: 0 },
      { date: "Mar 03", positive: 3, negative: 0, neutral: 0 },
      { date: "Mar 04", positive: 4, negative: 0, neutral: 0 },
      { date: "Mar 05", positive: 3, negative: 0, neutral: 1 },
      { date: "Mar 06", positive: 4, negative: 0, neutral: 0 },
      { date: "Mar 07", positive: 3, negative: 0, neutral: 0 },
      { date: "Mar 08", positive: 5, negative: 0, neutral: 0 },
      { date: "Mar 09", positive: 1, negative: 0, neutral: 0 },
    ],
    whatsHappeningKeyEvents: [
      { id: "1", date: "Feb 25", title: "Engagement Spike: 11 Mentions", description: "Highest interaction peak for Mitra Bukalapak based on organic mentions." },
    ],
    whatsHappeningTopTopics: [
      { topic: "Religious advice on charity", mentions: 2, sentiment: 80.0 },
      { topic: "Affirming patience", mentions: 1, sentiment: 70.0 },
      { topic: "App access issue", mentions: 1, sentiment: -80.0 },
      { topic: "App features praise", mentions: 1, sentiment: 80.0 },
      { topic: "App runs smoothly", mentions: 1, sentiment: 70.0 },
    ],
    whatsHappeningHashtags: [
      { id: "h1", tag: "#MitraBukalapak", conversations: 47, likes: 0, comments: 0 },
      { id: "h2", tag: "#TransaksiCepatAman", conversations: 47, likes: 0, comments: 0 },
      { id: "h3", tag: "#kultum", conversations: 18, likes: 0, comments: 0 },
      { id: "h4", tag: "#puasa", conversations: 18, likes: 0, comments: 0 },
      { id: "h5", tag: "#ramadan", conversations: 18, likes: 0, comments: 0 },
    ],
    whatsHappeningAITopicAnalysis: [
      { id: "T001", type: "insight", title: "Ramadan Promotions and Gamification", description: "Heavy volume of content and engagement surrounding Ramadan-specific campaigns, including 'Kejar Ketupat', remittance discounts (Rp500), and digital top-up promos." },
      { id: "T002", type: "critical", title: "App Stability and Account Friction", description: "Users are discussing technical barriers, primarily focusing on application login failures, QRIS connectivity, and unresponsive customer service for phone number changes." },
      { id: "T003", type: "trend", title: "Fraud Prevention Awareness", description: "Brand-led initiatives educating users about scams involving fake commissions and missions to protect merchant balances." },
    ],
    whatsHappeningTopicTrendsData: [
      { date: "Feb 25", "Religious advice on charity": 0, "Affirming patience": 0, "App access issue": 1 },
      { date: "Feb 26", "Religious advice on charity": 1, "Affirming patience": 0, "App access issue": 0 },
      { date: "Feb 27", "Religious advice on charity": 1, "Affirming patience": 0, "App access issue": 0 },
      { date: "Mar 04", "Religious advice on charity": 0, "Affirming patience": 1, "App access issue": 0 },
    ],
    whatsHappeningAITrendAnalysis: [
      { id: "TR001", type: "insight", title: "High Demand for Physical Payment Aids (Soundbox)", description: "Merchants are eager to upgrade their offline payment infrastructure to reduce friction caused by poor customer cellular data. Scale the production and promotional subsidies for the QRIS Soundbox to capture offline transaction market share." },
      { id: "TR002", type: "insight", title: "Integration of Religious Values and Business Coaching", description: "The target demographic strongly resonates with content that blends spiritual well-being (mental health/blessings) with practical business strategies. Maintain the 'NgaBreng' webinar series post-Ramadan with consistent weekly or monthly scheduling featuring community clerics and successful merchants." },
    ],
    whatsHappeningWordCloud: [
      { text: "mitrabukalapak", weight: 67, sentiment: "positive" },
      { text: "juragan", weight: 61, sentiment: "positive" },
      { text: "transaksicepataman", weight: 47, sentiment: "positive" },
      { text: "mitra", weight: 37, sentiment: "positive" },
      { text: "bukalapak", weight: 35, sentiment: "positive" },
      { text: "kultum", weight: 35, sentiment: "positive" },
      { text: "puasa", weight: 30, sentiment: "positive" },
      { text: "ramadan", weight: 29, sentiment: "positive" },
      { text: "ramadhan", weight: 26, sentiment: "positive" },
      { text: "berkah", weight: 18, sentiment: "positive" },
    ],
    whatsHappeningClusters: [
      { id: "1", theme: "Religious advice on charity", size: 2, sentiment: 0.8, trend: "upward", keywords: ["kultum", "sedekah", "share", "juragan"] },
    ],
    whatsHappeningAccounts: [
      { id: "18", name: "mitrabukalapak", handle: "@mitrabukalapak", platform: "instagram post", followers: 24560, conversations: 27, likes: 1604, replies: 723 },
      { id: "19", name: "mitrabukalapak", handle: "@mitrabukalapak", platform: "tiktok video", followers: 19280, conversations: 20, likes: 1252, replies: 1029 },
      { id: "13", name: "ck.uwaiz", handle: "@ck.uwaiz", platform: "tiktok comment", followers: 890, conversations: 15, likes: 26, replies: 25 },
      { id: "17", name: "meilanica09", handle: "@meilanica09", platform: "tiktok comment", followers: 620, conversations: 8, likes: 8, replies: 4 },
      { id: "22", name: "winargl", handle: "@winargl", platform: "tiktok comment", followers: 530, conversations: 2, likes: 2, replies: 2 },
    ],
    whatsHappeningContents: [
      { id: "1", title: "Buat Juragan yang mau menangin total hadiah R...", platform: "tiktok video", author: "mitrabukalapak", likes: 205, comments: 147 },
      { id: "2", title: "Top up digital pas Ramadan jadi makin berkah,...", platform: "instagram post", author: "mitrabukalapak", likes: 195, comments: 110 },
      { id: "3", title: "Ramadan tahun ini makin seru Juragan! Karena ...", platform: "instagram post", author: "mitrabukalapak", likes: 171, comments: 77 },
      { id: "4", title: "Juragan pernah diiming iming mengerjakan misi...", platform: "instagram post", author: "mitrabukalapak", likes: 147, comments: 254 },
    ],
    whatsHappeningKOLMatrix: [
      { id: "18", name: "mitrabukalapak", followers: 24560, positivity: 93, engagement: 2327, color: "green", category: "Official" },
      { id: "19", name: "mitrabukalapak", followers: 19280, positivity: 93, engagement: 2281, color: "blue", category: "Official" },
      { id: "13", name: "ck.uwaiz", followers: 890, positivity: 100, engagement: 51, color: "blue", category: "Organic" },
      { id: "17", name: "meilanica09", followers: 620, positivity: 100, engagement: 12, color: "blue", category: "Organic" },
      { id: "22", name: "winargl", followers: 530, positivity: 100, engagement: 4, color: "green", category: "Organic" },
    ],
    whatsHappeningAIKOLAnalysis: [
      { id: "K001", type: "insight", title: "Ust. Mochamad Ghany community engagement", description: "Ust. Mochamad Ghany is driving significant positive community engagement by aligning spiritual discussions with merchant mental resilience. Establish a long-term brand ambassadorship with Ust. Mochamad Ghany beyond Ramadan for continuous merchant education and community trust building." },
      { id: "K002", type: "insight", title: "Shopee KOL volume", description: "Shopee's massive dominance (304 mentions) suggests a highly active network of KOLs and affiliates driving competitor visibility. Counteract competitor KOL volume by launching a 'Mitra Influencer' program, incentivizing top 'Juwara' merchants to act as micro-KOLs on TikTok and Instagram." },
    ],
    whatsHappeningShareOfPlatform: [
      { date: "Feb 09", instagram: 1, tiktok: 0, googleplay: 0 },
      { date: "Feb 10", instagram: 1, tiktok: 0, googleplay: 0 },
      { date: "Feb 11", instagram: 1, tiktok: 0, googleplay: 1 },
      { date: "Feb 12", instagram: 1, tiktok: 0, googleplay: 1 },
      { date: "Feb 13", instagram: 1, tiktok: 0, googleplay: 1 },
      { date: "Feb 15", instagram: 1, tiktok: 0, googleplay: 0 },
      { date: "Feb 16", instagram: 0, tiktok: 0, googleplay: 1 },
      { date: "Feb 17", instagram: 1, tiktok: 0, googleplay: 0 },
      { date: "Feb 18", instagram: 1, tiktok: 0, googleplay: 0 },
      { date: "Feb 19", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Feb 20", instagram: 1, tiktok: 4, googleplay: 1 },
      { date: "Feb 21", instagram: 1, tiktok: 4, googleplay: 0 },
      { date: "Feb 22", instagram: 1, tiktok: 2, googleplay: 0 },
      { date: "Feb 23", instagram: 1, tiktok: 2, googleplay: 0 },
      { date: "Feb 24", instagram: 1, tiktok: 1, googleplay: 1 },
      { date: "Feb 25", instagram: 1, tiktok: 10, googleplay: 0 },
      { date: "Feb 26", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Feb 27", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Feb 28", instagram: 1, tiktok: 1, googleplay: 0 },
      { date: "Mar 01", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Mar 02", instagram: 1, tiktok: 4, googleplay: 0 },
      { date: "Mar 03", instagram: 1, tiktok: 2, googleplay: 0 },
      { date: "Mar 04", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Mar 05", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Mar 06", instagram: 1, tiktok: 3, googleplay: 0 },
      { date: "Mar 07", instagram: 1, tiktok: 2, googleplay: 0 },
      { date: "Mar 08", instagram: 1, tiktok: 4, googleplay: 0 },
      { date: "Mar 09", instagram: 1, tiktok: 0, googleplay: 0 },
    ],
    competitiveMatrixItems: [
      {
        id: "mb",
        ...
        mentions: 90,
        positivePercentage: 64.8,
        size: 90,
        color: "#dc2626",
        keywords: ["mitrabukalapak", "juragan", "transaksicepataman", "mitra", "bukalapak", "kultum", "puasa", "ramadan", "hari", "berkah"],
        competitivePosition: "Strong community engagement through religious and relatable 'Juragan' content, building high emotional loyalty despite technical hurdles.",
      },
      {
        id: "ms",
        name: "Mitra Shopee",
        mentions: 304,
        positivePercentage: 60.8,
        size: 304,
        color: "#ea580c",
        keywords: ["mitrashopee", "shopee", "promo", "admin", "mitra"],
        competitivePosition: "Aggressive market leader dominating conversations through massive promotion of ultra-low Rp100 admin fees for transfers.",
      },
      {
        id: "oq",
        name: "Order Kuota",
        mentions: 63,
        positivePercentage: 42.2,
        size: 63,
        color: "#2563eb",
        keywords: ["orderkuota", "kuota", "konter", "pulsa", "relate"],
        competitivePosition: "Niche player focusing on relatable content for credit sellers (konter), driving moderate engagement.",
      },
      {
        id: "bl",
        name: "BRILink",
        mentions: 5,
        positivePercentage: 32.0,
        size: 5,
        color: "#059669",
        keywords: ["brilink", "tarik", "tunai", "login", "error"],
        competitivePosition: "Traditional banking agent struggling with poor sentiment due to persistent app bugs and transaction failures.",
      },
    ],
    competitiveQuadrantAnalysis: [
      { id: "1", label: "Market Leaders", brands: "Mitra Shopee", note: "High Volume, Broad Market Reach" },
      { id: "2", label: "Fast Growing Contenders", brands: "Mitra Bukalapak, Order Kuota", note: "High positive sentiment, aggressive expansion" },
      { id: "3", label: "Premium Niche", brands: "BRILink", note: "Lower volume, traditional banking agent" },
      { id: "4", label: "Established Traditional", brands: "BRILink", note: "High brand awareness, varying digital engagement" },
    ],
    competitiveSentimentScores: [
      { issue: "App Error/Bug", "Mitra Bukalapak": 16.2 / 100, "Mitra Shopee": 55.0 / 100, "Order Kuota": 36.6 / 100, "BRILink": 15.0 / 100 },
      { issue: "General Service", "Mitra Bukalapak": 85.0 / 100, "Mitra Shopee": 79.2 / 100, "Order Kuota": 72.5 / 100, "BRILink": 78.8 / 100 },
      { issue: "Promo/Pricing", "Mitra Bukalapak": 93.8 / 100, "Mitra Shopee": 83.4 / 100, "Order Kuota": 78.3 / 100, "BRILink": 50.0 / 100 },
    ],
    competitiveVolumeOfMentions: [
      { issue: "App Error/Bug", "Mitra Bukalapak": 4, "Mitra Shopee": 2, "Order Kuota": 3, "BRILink": 1 },
      { issue: "General Service", "Mitra Bukalapak": 82, "Mitra Shopee": 205, "Order Kuota": 57, "BRILink": 4 },
      { issue: "Promo/Pricing", "Mitra Bukalapak": 4, "Mitra Shopee": 97, "Order Kuota": 3, "BRILink": 0 },
    ],
    competitiveShareOfVoice: [
      { date: "Feb 09", BRILink: 0, "Mitra Bukalapak": 1, "Mitra Shopee": 8, "Order Kuota": 1 },
      { date: "Feb 10", BRILink: 1, "Mitra Bukalapak": 1, "Mitra Shopee": 13, "Order Kuota": 1 },
      { date: "Feb 11", BRILink: 0, "Mitra Bukalapak": 2, "Mitra Shopee": 58, "Order Kuota": 1 },
      { date: "Feb 12", BRILink: 0, "Mitra Bukalapak": 2, "Mitra Shopee": 12, "Order Kuota": 0 },
      { date: "Feb 13", BRILink: 0, "Mitra Bukalapak": 2, "Mitra Shopee": 2, "Order Kuota": 2 },
      { date: "Feb 14", BRILink: 0, "Mitra Bukalapak": 0, "Mitra Shopee": 2, "Order Kuota": 0 },
      { date: "Feb 15", BRILink: 0, "Mitra Bukalapak": 1, "Mitra Shopee": 1, "Order Kuota": 0 },
      { date: "Feb 16", BRILink: 0, "Mitra Bukalapak": 1, "Mitra Shopee": 2, "Order Kuota": 1 },
      { date: "Feb 17", BRILink: 0, "Mitra Bukalapak": 1, "Mitra Shopee": 1, "Order Kuota": 2 },
      { date: "Feb 18", BRILink: 0, "Mitra Bukalapak": 1, "Mitra Shopee": 3, "Order Kuota": 9 },
      { date: "Feb 19", BRILink: 0, "Mitra Bukalapak": 4, "Mitra Shopee": 2, "Order Kuota": 10 },
      { date: "Feb 20", BRILink: 0, "Mitra Bukalapak": 6, "Mitra Shopee": 3, "Order Kuota": 2 },
      { date: "Feb 21", BRILink: 0, "Mitra Bukalapak": 5, "Mitra Shopee": 2, "Order Kuota": 2 },
      { date: "Feb 22", BRILink: 0, "Mitra Bukalapak": 3, "Mitra Shopee": 2, "Order Kuota": 0 },
      { date: "Feb 23", BRILink: 0, "Mitra Bukalapak": 3, "Mitra Shopee": 15, "Order Kuota": 1 },
      { date: "Feb 24", BRILink: 0, "Mitra Bukalapak": 3, "Mitra Shopee": 40, "Order Kuota": 0 },
      { date: "Feb 25", BRILink: 0, "Mitra Bukalapak": 11, "Mitra Shopee": 28, "Order Kuota": 2 },
      { date: "Feb 26", BRILink: 1, "Mitra Bukalapak": 4, "Mitra Shopee": 5, "Order Kuota": 2 },
      { date: "Feb 27", BRILink: 0, "Mitra Bukalapak": 4, "Mitra Shopee": 3, "Order Kuota": 1 },
      { date: "Feb 28", BRILink: 0, "Mitra Bukalapak": 2, "Mitra Shopee": 2, "Order Kuota": 1 },
      { date: "Mar 01", BRILink: 0, "Mitra Bukalapak": 4, "Mitra Shopee": 2, "Order Kuota": 1 },
      { date: "Mar 02", BRILink: 1, "Mitra Bukalapak": 5, "Mitra Shopee": 8, "Order Kuota": 4 },
      { date: "Mar 03", BRILink: 0, "Mitra Bukalapak": 3, "Mitra Shopee": 10, "Order Kuota": 4 },
      { date: "Mar 04", BRILink: 1, "Mitra Bukalapak": 4, "Mitra Shopee": 49, "Order Kuota": 2 },
      { date: "Mar 05", BRILink: 0, "Mitra Bukalapak": 4, "Mitra Shopee": 9, "Order Kuota": 4 },
      { date: "Mar 06", BRILink: 0, "Mitra Bukalapak": 4, "Mitra Shopee": 5, "Order Kuota": 4 },
      { date: "Mar 07", BRILink: 0, "Mitra Bukalapak": 3, "Mitra Shopee": 1, "Order Kuota": 4 },
      { date: "Mar 08", BRILink: 1, "Mitra Bukalapak": 5, "Mitra Shopee": 6, "Order Kuota": 2 },
      { date: "Mar 09", BRILink: 0, "Mitra Bukalapak": 1, "Mitra Shopee": 10, "Order Kuota": 0 },
    ],
    competitiveBrandLabels: {
      yourBrand: "Mitra Bukalapak",
      competitors: ["Mitra Shopee", "Order Kuota", "BRILink"],
    },
    campaigns,
  };
}
...
export function getInitialDashboardContentForInstance(instanceId: string, defaultContent: DashboardContentStore): DashboardContentStore | null {
  ...
  if (instanceId === "mitra_bukalapak_dashboard") return buildMitraBukalapakDashboardInitial(defaultContent);
